"""Defines subtract_massive_bodies function."""
import numpy as np
...
def subtract_massive_bodies(
    ...
    Args:
        ...
        mb2 (MassiveBody): MassiveBody 2 to subtract.
        reference_frame (Frame): reference frame for the resulting MassiveBody.
    
    Returns:
        mb3 (MassiveBody): Subtracted mass properties.
    """
    ...
    # transform frame to new reference frame:
    mb3.cm = mb3.cm.transform_to_frame(
